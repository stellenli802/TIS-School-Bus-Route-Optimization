...
stops_file = open('//Users/stellenshun.li/Desktop/12th Grade/AP Research/Paper/Codes/stops/stops.txt','r')
stops_names = open('//Users/stellenshun.li/Desktop/12th Grade/AP Research/Paper/Codes/stops/stops_names2.txt','r')
...
with open(r'//Users/stellenshun.li/Desktop/12th Grade/AP Research/Paper/Codes/Data/'+time + '.txt', 'w') as filehandle:
    for i in range(len(names_segments)):
            filehandle.write(names_segments[i] + '\n')
